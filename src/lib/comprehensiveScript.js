...
// =============================================================================
export const section2Authority = {
...
export const getNextSection = (currentSectionId) => {
    ...
    return Object.values(comprehensiveScript).find(section => section.sectionNumber === nextSectionNumber);
};
...
export const getObjectionById = (objectionId) => {
