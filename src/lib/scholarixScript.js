export const getIndustryPain = (industry) => {
    const pains = {
...
export const getIndustryExample = (industry) => {
    const examples = {
...
export const getIndustryProcess = (industry) => {
    const processes = {
...
export const getIndustrySuccessStory = (industry) => {
    const stories = {
...
export const getIndustryTimeWaster = (industry) => {
    const timeWasters = {
...
export const determineOutcome = (nodeId) => {
    if (nodeId === 'end-demo-booked' || nodeId === 'confirm-demo')
        return 'demo-booked';
    if (nodeId === 'end-follow-up')
        return 'follow-up-scheduled';
    if (nodeId === 'end-not-interested')
        return 'not-interested';
    if (nodeId === 'in-progress')
        return 'in-progress';
    return 'in-progress';
};
