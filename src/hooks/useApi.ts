...
import type { Call, Lead, User, CallWithDetails, LeadDetailed } from '@/lib/types';

/**
 * Hook to fetch all calls with optional filters
 */
export function useCalls(filters: { limit?: number; leadId?: string } = {}) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return data.calls as CallWithDetails[];
    },
...
export function useCall(callId: string) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const data = await response.json();
      return data.call as CallWithDetails;
    },
    enabled: !!callId,
  });
}
...
export function useLeads(filters: {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const data = await response.json();
      return data.leads as LeadDetailed[];
    },
...
export function useLead(leadId: string) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const data = await response.json();
      return data.lead as LeadDetailed;
    },
    enabled: !!leadId,
  });
}
...
export function useCreateLead() {
  ...
  return useMutation({
    ...
    onMutate: async (newLead) => {
      ...
      queryClient.setQueryData(queryKeys.leads.lists(), (old: any) => {
    ...
    onError: (err, newLead, context) => {
      ...
      logger.error('Failed to create lead', err as Error);
    },
    onSuccess: () => {
